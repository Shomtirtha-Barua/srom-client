...
const DashboardProfile = () => {
  const [worker] = useAuthState(auth);
  const { displayName, email, photoURL } = worker;
          ...
          <div className="bg-white shadow rounded-lg p-6">
            <div className="flex flex-col items-center">
              ...
              <div className="mt-6 flex flex-wrap gap-4 justify-center">
                <a
                  href="#"
                  className="bg-gray-300 hover:bg-sky-400 hover:text-white text-gray-700 py-2 px-4 rounded"
                >
                  Update
                </a>
              </div>
            ...
            <div className="flex flex-col">
              ...
              <ul>
                <li className="mb-2">Electrician</li>
                <li className="mb-2">Gas/Burn</li>
              </ul>
            </div>
          </div>
        </div>
