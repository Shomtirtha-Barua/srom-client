        ...
        <div className="gap-6 justify-between md:flex">
          <div className="flex-1">
            <div className="max-w-xs">
              <Link to='/' className="text-4xl text-rose-500">SROM</Link>
